...
module.exports.getMarqueById = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Erreur lors de la récupération de la marque" });
  }
};
...
module.exports.deleteMarqueById = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Erreur lors de la suppression de la marque" });
  }
};
...
module.exports.postMarque = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Erreur lors de la création de la marque" });
  }
};

...
module.exports.getModeles = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Erreur lors de la récupération des modeles" });
  }
};
...
module.exports.getModeleById = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Erreur lors de la récupération de la modele" });
  }
};
...
module.exports.deleteModeleById = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Erreur lors de la suppression de la modele" });
  }
};
...
module.exports.postModele = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Erreur lors de la création de la modele" });
  }
};

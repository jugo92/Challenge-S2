const factures = require("../Helper/genereFactures");
const PDFFile = require("../Models/dbGenerated");
const generatedFacture = require("../Helper/genereFactures");
...
module.exports.genereFactureById = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .send({ error: "Error while getting or generating facture" });
  }
};
//test withoud db
...
module.exports.genereFacture = async (req, res) => {
  try {
    ...
    const pdfPath = res.send(pdfContent);
  } catch (err) {

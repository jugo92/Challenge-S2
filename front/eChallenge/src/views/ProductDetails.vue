...
<span class="text-base text-gray-600 dark:text-gray-600">En stock</span>
<p class="mt-2 text-sm text-blue-500 dark:text-blue-500">Expedier à partir de la france

<template>
    ...
    <div class=" mx-auto p-8">
      ...
      <form @submit.prevent="updateSettings">
        ...
        <div class="mb-4"> 
            ...
            <input type="checkbox" checked="checked" v-model="user.notifications" id="notification">
        ...
        <div class="mb-4">
          ...
          <input v-model="user.nom" type="text" id="nom" name="nom" class="mt-1 p-2 w-full border rounded-md">
        </div>
  
        <div class="mb-4">
          <label for="prenom" class="block text-sm font-medium text-gray-600">Prénom</label>
          <input v-model="user.prenom" type="text" id="prenom" name="prenom" class="mt-1 p-2 w-full border rounded-md">
        </div>
        ...
        <div class="mb-4">
          ...
          <input v-model="user.oldpassword" type="password" id="oldPassword" name="oldPassword" class="mt-1 p-2 w-full border rounded-md">
        </div>
        <div class="mb-4">
        ...
        <div class="text-blue-500">
          <a href="/reset-password" class="text-sm hover:underline">Mot de passe oublié ?</a>
        </div>
  ...
  const updateSettings = () => {
    console.log('Enregistrement des paramètres :', user.value);
  };
  </script>

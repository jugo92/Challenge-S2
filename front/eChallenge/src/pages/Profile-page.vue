        ...
        <div class="bg-white rounded-lg shadow-xl pb-8">
            ...
            <div class="text-blue-500">
                <a href="/" class="flex items-center space-x-2 px-8 py-4">
                    ...
                    <span class="text-sm text-gray-500 hover:text-gray-600">Back to Home</span>
                </a>
            </div>
            ...
            <div class="flex flex-col items-center -mt-20">
                <img src="https://zupimages.net/up/23/46/5cq9.jpg" class="w-40 border-4 border-white rounded-full">
                ...
                <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                    ...
                    <ul class="mt-2 text-gray-700">
                        <li class="flex border-y py-2">
                            ...
                            <span class="text-gray-700">Ady Masivi</span>
                        </li>
                        <li class="flex border-b py-2">
                            <span class="font-bold w-24">date de naissance:</span>
                            <span class="text-gray-700">12 Juin, 1997</span>
                        </li>
                        <li class="flex border-b py-2">
                            <span class="font-bold w-24">Inscrit le:</span>
                            <span class="text-gray-700">12.01.2022</span>
                        </li>
                        <li class="flex border-b py-2">
                            <span class="font-bold w-24">Teléphone:</span>
                            <span class="text-gray-700">0661172371</span>
                        </li>
                        <li class="flex border-b py-2">
                            <span class="font-bold w-24">Email:</span>
                            <span class="text-gray-700">amasivi@masivi.com</span>
                        </li>
                       
                        <li class="flex border-b py-2">
                            <span class="font-bold w-24 ">Adresse:</span>
                            <span class="text-gray-700">Avenue tec...</span>
                        </li>
                       
                    </ul>
                </div>
                <div class="flex-1 bg-white rounded-lg shadow-xl mt-4 p-8">
                    <h4 class="text-xl text-gray-900 font-bold">les 6 dernières commandes</h4>
                    <div class="relative px-4">
                        ...
                        <div class="flex items-center w-full my-6 -ml-1.5">
                            ...
                            <div class="w-11/12">
                                <p class="text-sm">
                                   commande<a href="#" class="text-blue-600 font-bold"> Macbook</a> neuf</p>
                                <p class="text-xs text-gray-500">3 mois</p>
                            </div>
                        </div>
                        <!-- end::Timeline item -->
                    </div>
